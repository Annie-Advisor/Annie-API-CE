...
insert into survey (id,updatedby,starttime,endtime,config,contacts,status)
values
('Y','Annie',date_trunc('day',now()),'2049-12-31 23:59:59','{"name": {"en": "Student initiated", "fi": "Opiskelijan aloite"}, "other": {"message": "Kiitos viestistäsi.", "supportneed": true}}',null,'IN PROGRESS')
ON CONFLICT DO NOTHING;
...
insert into annieusersurvey (annieuser,survey,updatedby,meta)
values
('devops@annieadvisor.com','Y','Annie','{"category":{"Y":true}}')
ON CONFLICT DO NOTHING;
